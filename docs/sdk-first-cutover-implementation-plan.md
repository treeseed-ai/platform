...
- Next action: wait for fresh exact-head checks on CLI `2e9610a6…`, API `65495a70…`, and Agent `b6f07113…`; inspect failures, obtain independent review, and integrate/read back each consumer to staging only after green evidence. Keep SDK main and npm publication blocked.
...
- Exact candidate heads: SDK staging `92a66135fbda5575bee058b0ab25339c6c7d6398`; CLI `2e9610a60cfddc7a7bea679487530667b10a8407`; API `65495a70f08086671c6dccf55a675559a530409d`; Agent `b6f07113536d8420f0ac6c0e1c445dc38947062c`
...
| Definition/PR-contract cutover | SDK reviewed head `5eff7d1bf728c1eb40e50073b164a7dd99721d8f`, verified staging `92a66135fbda5575bee058b0ab25339c6c7d6398`; CLI `2e9610a60cfddc7a7bea679487530667b10a8407`; API `65495a70f08086671c6dccf55a675559a530409d`; Agent `b6f07113536d8420f0ac6c0e1c445dc38947062c` | SDK staging source/artifact are independently accepted. Consumers adopt the exact staging identity and pass local definition tests; exact-head hosted checks/review and staging integration remain. |

...
- Next action: wait for final post-merge package Verify runs and SDK staging Content `32209160738`; download and digest-bind all four staging Content receipts, then mark the common definition/content cutover verified and proceed to settlement/local TreeDX deployment. Keep SDK main and npm publication blocked.

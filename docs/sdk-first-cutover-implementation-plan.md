...
- Exact candidate heads: SDK `2cb803ab2db7db492adceae84cbdc0900a23a9a5`; CLI `95cd2ef7e1aa2b093218f3269262bde77f243740`; API `0ebccc6653e50176d01ec226f11ae8e033762c23`; Agent `0f619e0b6e1d4a8607621d31acfe05b64d2f013a`
...
- Hosted correction: the first SDK head failed architecture because the new evaluator created an eleventh direct validation file, and a feature-branch Content push attempted external R2 publication. Commit `2de71415…` moves the evaluator under functional ownership and limits content publication pushes to `main`/`staging`; PR validation remains local and credential-free. The next exact-head run exposed one pre-existing read-only question-answerer fixture that relied on implicit mutation presets; SDK head `2cb803ab…` declares the four content mutation tools denied and passes the focused contract. Agent head `0f619e0b…` likewise moves its regression test into a functional subdomain after the first head exceeded the ten-file test-root limit. Fresh hosted checks are pending.
...
| Definition-compatibility candidates | SDK `2cb803ab2db7db492adceae84cbdc0900a23a9a5`; CLI `95cd2ef7e1aa2b093218f3269262bde77f243740`; API `0ebccc6653e50176d01ec226f11ae8e033762c23`; Agent `0f619e0b6e1d4a8607621d31acfe05b64d2f013a` | Draft PRs target staging; exact-head hosted verification/review and staging read-back are pending. Consumers pin the shipped evaluator at SDK `2de71415…`; the later SDK-only commit changes only a contract fixture. |

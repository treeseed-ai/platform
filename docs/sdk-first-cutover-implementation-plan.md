...
- Next action: wait for SDK staging Verify run `32205531009`, read back artifact `sdk-92a66135fbda5575bee058b0ab25339c6c7d6398`, and compare it to the reviewed artifact. Only then may API/CLI/Agent adopt staging merge `92a66135…`; make consumer hydration fail fast when an exact producer has already failed and rerun consumer checks. Keep main and npm publication blocked.
...
- Exact candidate heads: SDK `5eff7d1bf728c1eb40e50073b164a7dd99721d8f`; CLI `1b961c9d05ab224ded2383ceb543f5a1eb858330`; API `063f323aafd5eed03f873edc34c71fd0a36115f6`; Agent `bbe857622344f69ebd9a538ffd1c95d35b565eac`
...
- SDK staging integration: independent re-review found no remaining findings at `5eff7d1bf728c1eb40e50073b164a7dd99721d8f`. Push Verify `32204837867`, PR Verify `32204841864`, and Content `32204841934` passed; local, push, and PR artifacts were byte-identical at SHA-256 `e19dc65481dceb76ca60b6c36b93ff1314cdd5c0b85dc977365f5c7c825510ba`. PR [#4](https://github.com/treeseed-ai/sdk/pull/4) merged to staging as `92a66135fbda5575bee058b0ab25339c6c7d6398`, and `git ls-remote` returned that exact ref. Staging Verify run [`32205531009`](https://github.com/treeseed-ai/sdk/actions/runs/32205531009) and its exact merge artifact/read-back are pending; consumers remain blocked until they pass.
...
| Definition/PR-contract cutover | SDK reviewed head `5eff7d1bf728c1eb40e50073b164a7dd99721d8f`, staging merge `92a66135fbda5575bee058b0ab25339c6c7d6398`; CLI `1b961c9d05ab224ded2383ceb543f5a1eb858330`; API `063f323aafd5eed03f873edc34c71fd0a36115f6`; Agent `bbe857622344f69ebd9a538ffd1c95d35b565eac` | SDK PR #4 is independently approved, merged, and remotely read back; staging Verify/artifact remain pending. Consumer PRs pin obsolete intermediate SDK `2de71415…` and cannot become accepted until they adopt verified SDK staging. |

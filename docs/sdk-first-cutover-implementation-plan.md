...
- Next action: create the governed SDK canary worktree at `f843c3cb…`, reproduce only the two independently diagnosed baseline test repairs, and run focused plus clean package acceptance.
